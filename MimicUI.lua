...
-- ปุ่ม Toggle + ปุ่ม ⬆⬇ อยู่มุมขวาบนด้วยกัน
...
floatUp.Position = UDim2.new(1,-104,0,10)
...
floatDown.Position = UDim2.new(1,-154,0,10)
...
createToggleButton(scroll, "God Mode", "🛡", 362, function(state)
	godEnabled = state
end)
