...
scroll.CanvasSize = UDim2.new(0,0,0,562)  -- ความสูงเนื้อหาทั้งหมด
...
createToggleButton(scroll, "Set HP 100", "❤", 469, function(state)
	hpBoostEnabled = state
	if state then enableHPBoost() else disableHPBoost() end
end)

divider.Size = UDim2.new(1,-24,0,1); divider.Position = UDim2.new(0,12,0,476)
...
hint.Size = UDim2.new(1,-24,0,70); hint.Position = UDim2.new(0,12,0,482)
